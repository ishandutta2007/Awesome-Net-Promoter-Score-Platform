...
flowchart TD
    ...
    A[Customer Interaction] --> B[Survey Trigger]
    ...
    F --> I[Improvement Workflow]

    G --> J[Advocacy Workflow]



    H --> K[Support / Customer Success]

    I --> K

    J --> L[Referral / Review / Advocacy]



    C --> M[Feedback Database]

    M --> N[Analytics Dashboard]

    M --> O[AI Feedback Analysis]



    O --> P[Themes & Sentiment]

    N --> Q[Management Insights]
...
flowchart LR
    ...
    A[Customer / User] --> B[Formbricks / LimeSurvey]
    ...
    E --> H[EspoCRM / SuiteCRM]

    F --> I[Metabase / Superset]

    G --> J[Node-RED / Activepieces]
    ...
    I --> O[Customer Experience Dashboard]
